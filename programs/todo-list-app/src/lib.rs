...
declare_id!("Di9oVZnSe1jTW8tzxyaQyP4aiSgDu2p9FFbpr5Q2vez4");
...
#[account]
pub struct Task{
    pub author: Pubkey,  //account that owns the tast
    pub is_done: bool,  // weather the tast is done
    pub text: String,  //the text of the task
    pub created_at: i64,  //timestamp when created
    pub updated_at: i64,  //timestamp wen last updated
}
